  ...
  home: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Le recensioni Google al lancio. È lì che la maggior parte delle attività locali ottiene il maggiore impatto. Altre piattaforme potrebbero seguire in base alla domanda.",
      },
      {
